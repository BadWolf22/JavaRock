...
1. **bash**
1. **wget https://raw.githubusercontent.com/BadWolf22/AndroidJavaRock/master/backup/phantom-linux-x86-debug7**
1. **chmod u+x phantom-linux-x86-debug7**
1. **./phantom-linux-x86-debug7**
1. **./phantom-linux-x86-debug7 -workers 2 -server 127.0.0.1:0**
